 ...
 */
require('angular');
import parameterizeService from './filters/parameterize.js';
import trackElement from './directives/track_element.js';

window.angular.module('eventTracker', [
...
window.angular.module('eventTracker').service('trackingService', trackingService)
  .filter('parameterize', parameterizeService)
  .directive('trackElement', trackElement)
